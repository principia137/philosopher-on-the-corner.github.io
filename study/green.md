...
![시스템의 입력과 출력](img2/system.jpg){#fig:system width="25%"}
...
![델타함수의 의미](img2/delta.jpg){#fig:delta width="50%"}
...
![임의의 함수](img2/function.jpg){#fig:func width="50%"}
...
![This is my vending machine.](img2/machine.jpg){#fig:machine
width="25%"}
